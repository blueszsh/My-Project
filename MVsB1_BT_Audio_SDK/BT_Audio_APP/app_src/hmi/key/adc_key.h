...
typedef enum _AdcKeyType
{
	...
	ADC_KEY_DOUBLE_RELEASED,// zsh A2
	ADC_KEY_3_CLICK_RELEASED=8,
    ADC_KEY_LONG_2S_RELEASED = 9,
	ADC_KEY_LONG_3S_RELEASED,
	ADC_KEY_LONG_4S_RELEASED,
	ADC_KEY_LONG_5S_RELEASED,
	ADC_KEY_LONG_6S_RELEASED,
	ADC_KEY_STATE_NS_RELEASE,
