...
#define Z__DEBUG_custom                 1          //开启串口调试,生产的软件务必关闭   具体打印选项到TOP3开启
...
#define Pin_BAT_check                 Port_LDOIN//  Port_A31
...
#define Z__EFFECT_usb_DEBUG_PASSWORD_EN        0     ////调音通讯加密
...
#define LEDS_mix_RGB_EN                     0         //混色RGB灯 使能
...
#define IO_KEY_10_EN                    0           //编号为10的按键
