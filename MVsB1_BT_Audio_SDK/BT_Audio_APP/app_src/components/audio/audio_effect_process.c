...
#ifdef CFG_FUNC_EQMODE_FADIN_FADOUT_EN
	if((music_pcm)&&(mainAppCt.EqModeBak != mainAppCt.EqMode))
	{		
...
//			monitor_out = i2s_out;
		...
		if(remind_in)
		{
			...
			if(tws_in)
			{
				for(s = 0; s < n; s++)
				{
					...
					monitor_out[2*s + 0] = __nds32__clips((((int32_t)tws_in[2*s + 0] + (int32_t)remind_in[2*s + 0])), 24-1);
					monitor_out[2*s + 1] = __nds32__clips((((int32_t)tws_in[2*s + 1] + (int32_t)remind_in[2*s + 1])), 24-1);
#else
					monitor_out[2*s + 0] = __nds32__clips((((int32_t)tws_in[2*s + 0] + (int32_t)remind_in[2*s + 0])), 16-1);
					monitor_out[2*s + 1] = __nds32__clips((((int32_t)tws_in[2*s + 1] + (int32_t)remind_in[2*s + 1])), 16-1);
#endif
				}
			...
			if(music_in)
			{
				...
				{
#ifdef CFG_AUDIO_WIDTH_24BIT
					monitor_out[2*s + 0] = __nds32__clips((((int32_t)music_in[2*s + 0] + (int32_t)remind_in[2*s + 0])), 24-1);
					monitor_out[2*s + 1] = __nds32__clips((((int32_t)music_in[2*s + 1] + (int32_t)remind_in[2*s + 1])), 24-1);
#else
					monitor_out[2*s + 0] = __nds32__clips((((int32_t)music_in[2*s + 0] + (int32_t)remind_in[2*s + 0])), 16-1);
					monitor_out[2*s + 1] = __nds32__clips((((int32_t)music_in[2*s + 1] + (int32_t)remind_in[2*s + 1])), 16-1);
#endif
				}
			}
			else
		...
		if(i2s0_in)
		{
			...
			{
				#ifdef CFG_AUDIO_WIDTH_24BIT
				monitor_out[2*s + 0] = __nds32__clips((((int32_t)monitor_out[2*s + 0] + (int32_t)i2s0_in[2*s + 0])), 24-1);
				monitor_out[2*s + 1] = __nds32__clips((((int32_t)monitor_out[2*s + 1] + (int32_t)i2s0_in[2*s + 1])), 24-1);
				#else
		...
		if(i2s1_in)
		{
			...
			{
				#ifdef CFG_AUDIO_WIDTH_24BIT
				monitor_out[2*s + 0] = __nds32__clips((((int32_t)monitor_out[2*s + 0] + (int32_t)i2s1_in[2*s + 0])), 24-1);
				monitor_out[2*s + 1] = __nds32__clips((((int32_t)monitor_out[2*s + 1] + (int32_t)i2s1_in[2*s + 1])), 24-1);
				#else
	...
	if(record_out)
	{
		...
		{
#ifdef CFG_AUDIO_WIDTH_24BIT
			record_out[s] = __nds32__clips(((int32_t)record_out[2*s] + (int32_t)record_out[2*s + 1] +1 ) >>1, 24-1);
#else
			record_out[s] = __nds32__clips(((int32_t)record_out[2*s] + (int32_t)record_out[2*s + 1] +1 ) >>1, 16-1);
#endif
		}
#ifdef FUNC_OS_EN
		if(AudioEffectMutex != NULL)
		...
		if(remind_in)
		{
			if(RemindSoundIsMix())
			{
				...
				{
#ifdef CFG_AUDIO_WIDTH_24BIT
					temp 			= __nds32__clips(((int32_t)remind_in[2*s] + (int32_t)remind_in[2*s + 1] + 1) >> 1, 24-1);
					record_out[s]	= __nds32__clips(((int32_t)temp + (int32_t)record_out[s]), 24-1);
#else
					temp 			= __nds32__clips(((int32_t)remind_in[2*s] + (int32_t)remind_in[2*s + 1] + 1) >> 1, 16-1);
					record_out[s]	= __nds32__clips(((int32_t)temp + (int32_t)record_out[s]), 16-1);
#endif
				}
			}
			else
			{
				...
				{
#ifdef CFG_AUDIO_WIDTH_24BIT
					record_out[s] 	= __nds32__clips(((int32_t)remind_in[2*s] + (int32_t)remind_in[2*s + 1] + 1)>>1, 24-1);
#else
					record_out[s] 	= __nds32__clips(((int32_t)remind_in[2*s] + (int32_t)remind_in[2*s + 1] + 1)>>1, 16-1);
#endif
				}
			}
		}
