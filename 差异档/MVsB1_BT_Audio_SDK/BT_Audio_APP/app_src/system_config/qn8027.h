...
#ifndef CFG_RADIO_IIC_ENABLE
#define CFG_RADIO_IIC_ENABLE()				GPIO_PortBModeSet(GPIOA5, 0x0),GPIO_PortBModeSet(GPIOA6, 0x0)
#endif
#ifndef CFG_RADIO_IIC_HANDLER
#define CFG_RADIO_IIC_HANDLER()				I2cMasterCreate(PORT_A, 5, PORT_A, 6)
#endif
...
#define FMTX_CHIP_CLK_SOURCE        CLK_BY_EXTERN_OSC
#define _OSC_24M						2
#define FMTX_CHIP_OSC_SELECT	  _OSC_24M
